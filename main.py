...
# except:
bot = commands.Bot(command_prefix=commands.when_mentioned_or('sudo.'), case_insensetive=True, help_command=EmbedHelpCommand(command_attrs = {'help': 'asd'}), case_insensitive=True)
...
# bot.run('NzI5NzE1NTcyOTUwMDQwNjE3.XwW6lA.SjwYKeKrQmwI0SydIw5pRuyxLok')
